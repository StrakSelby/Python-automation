# pandas use for spreadsheets
import pandas as pd
# request use for sending request to the server
import requests
# BeautifulSoup is use for Scraping the content from the web
...
def gather_data_from_sources():
        data_from_csv = pd.read_csv('assets/sales_data.csv')
        # Fetching data from a website using requests & BeautifulSoup
...
process_data = process_and_format_data(raw_data)
